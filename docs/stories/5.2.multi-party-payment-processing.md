...
- `POST /orders/{id}/process-payment` - Process payment with splits
- `PUT /orders/{id}/status` - Update order status
- `GET /orders/{id}/tracking` - Get order status and tracking info
- `POST /orders/{id}/refund` - Process refund request

**Customer Endpoints**:
- `GET /customers/{email}/orders` - Customer order history
- `GET /orders/{id}/receipt` - Order receipt and details
...
- `apps/api/src/services/order.service.ts` - Core order management
- `apps/api/src/services/checkout.service.ts` - Checkout flow orchestration
- `apps/api/src/services/inventory.service.ts` - Inventory allocation and tracking
- `apps/api/src/services/tax.service.ts` - Tax calculation and compliance

**API Routes**:
- `apps/api/src/api/orders/` - Order management endpoints
- `apps/api/src/api/checkout/` - Checkout flow endpoints
- `apps/api/src/api/customers/` - Customer order endpoints

**Database Models**:
- `apps/api/src/models/order.entity.ts` - Order TypeORM entity
- `apps/api/src/models/order-item.entity.ts` - Order item entity
- `apps/api/src/models/payment-split.entity.ts` - Revenue split tracking
...
**Test File Locations**:
- Service tests: `apps/api/src/services/__tests__/order.service.test.ts`
- Integration tests: `apps/api/src/api/orders/__tests__/`
- End-to-end tests: `apps/api/src/__tests__/order-flow-e2e.test.ts`
- Payment tests: `apps/api/src/__tests__/payment-processing.test.ts`
